  ...
  const [notifications, setNotifications] = useState<Notification[]>([
    {
      id: "1",
      type: "new_order",
      message: "Nouvelle commande pour la table 8 - Rodriguez",
      orderId: "3",
    ...
    },
    {
      id: "2",
      type: "new_order",
      message: "Commande prête pour la table 4 - Martin",
      orderId: "2",
  ...
  const handleMarkReady = async (orderId: string) => {
    ...
    if (order) {
      setNotifications(prev => [...prev, {
        ...
        type: "new_order",
        message: `Commande servie pour la table ${order.tableId} - ${order.customerName} - En attente de paiement`,
        orderId,
        timestamp: new Date(),
        read: false
      }]);
