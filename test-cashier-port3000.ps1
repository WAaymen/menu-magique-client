...
Write-Host "    Testing Cashier App on Port 3000" -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan
Write-Host ""
...
Write-Host ""
Write-Host "Starting Cashier App on port 3000..." -ForegroundColor Green
Write-Host "Using: npm run dev (which forces port 3000)" -ForegroundColor Green
Set-Location "Caissier"
npm run dev

Write-Host ""
Write-Host "Cashier App should now be running on:" -ForegroundColor Yellow
